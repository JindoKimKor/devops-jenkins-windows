    ...
    stages {
        ...
        stage('Build Project') {
            steps {
                ...
                sh "if not exist \"${WORKING_DIR}/Assets/Editor/\"; then mkdir -p \"${WORKING_DIR}/Assets/Editor/\"; fi;" //The following line assumed this folder exists in every project, adding check to ensure it does.
